...
public class Hash_01 {
    public static void main(String[] args) {
        ...
        System.out.println("Ex 5,6,7: 5) Sim, houveram 4 colisões.\n" +
                "6) As colisões foram identificadas e o valor previamente presente no slot não foi alterado, gerando perda de dados.\n" +
                "7) O tratamento das colisões poderia ser feito utilizando-se o encadeamento ou endereçamento aberto.");
    }
        // -----------------------------------------------------------
